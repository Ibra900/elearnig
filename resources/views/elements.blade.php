							...
							<div class="input-group-icon mt-10">
								...
								<div class="form-select" id="default-select" ">
								 ...
								 input-group-icon mt-10 ">
										<div class=" icon "><i class=" fa fa-globe " aria-hidden=" true
								 "></i></div>
										<div class=" form-select " id=" default-select
								 ">
									<select>
						...
						<div class="
							...
							<div class=" switch-wrap d-flex justify-content-between
							 ">
								...
								<div class=" disabled-checkbox
							 ">
									<input type=" checkbox " id=" disabled-checkbox-active
							 " checked disabled>
						...
						<div class=" single-element-widget mt-30
							...
							<div class=" switch-wrap d-flex justify-content-between
							 ">
								...
								<div class=" primary-radio ">
									<input type="
							 checkbox " id=" primary-radio " checked>
							...
							<div class=" switch-wrap d-flex justify-content-between
							 ">
								...
								<div class=" confirm-radio ">
									<input type="
							 checkbox " id=" confirm-radio " checked>
							...
							<div class=" switch-wrap d-flex justify-content-between
							 ">
								...
								<div class=" disabled-radio ">
									<input type="
							 checkbox " id=" disabled-radio " disabled>
							...
							<div class=" switch-wrap d-flex justify-content-between
							 ">
								...
								<div class=" disabled-radio ">
									<input type="
							 checkbox " id=" disabled-radio-active " checked disabled>
